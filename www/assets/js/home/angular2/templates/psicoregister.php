         ...
         <div class="container pg-content">
            <div class="col-sm-12 text-center">
               ...
               <form method="POST" id="registerForm" name="register" class="form-horizontal contact-form support">
                  ...
                  <div class="form-group">
                     <div class="col-sm-12 inputGroupContainer">
                        <div class="input-group"> <span class="input-group-addon"><i class="fa fa-phone"></i></span> <input type="text" name="registerPhone" autocomplete="off" placeholder="<?php echo $lang['home']['register']['form']['phoneObligatory'] ?>" class="form-control"> </div>
                     </div>
                  </div>
                  <div class="form-group">
                     <div class="col-sm-6">
