...
/***/ (function(module, exports, __webpack_require__) {
	...
	Card = (function() {
	  ...
	  Card.prototype.attachHandlers = function() {
	    ...
	    bindVal(this.$maskedNumberInput, this.$numberDisplay, {
	      fill: false,
	  ...
	  bindVal = function(el, out, opts) {
	    ...
	    QJ.on(el, 'click keyup change paste', function(e) {
	...
	(function() {
	  ...
	  Payment = (function() {
	    ...
	    Payment.formatCardNumber = function(el) {
	      ...
	      QJ.on(el, 'click keyup blur', setCardType);
