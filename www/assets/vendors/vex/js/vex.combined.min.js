                        ...
                        3: [function(a, b, c) {
                            var d = a("domify"),
                                ...
                                f = function(a) {
                                    ...
                                    var extraContentClass = '';
                                    if(typeof a.additionalClass != 'undefined')
                                    {
                                        extraContentClass = a.additionalClass;
                                    }
                                    b.classList.add("vex-dialog-form"), (extraContentClass != '' ? b.classList.add(extraContentClass):'');
                                    var c = document.createElement("div");
                                    c.classList.add("vex-dialog-message"), (extraContentClass != '' ? c.classList.add(extraContentClass):''),c.appendChild(a.message instanceof window.Node ? a.message : d(a.message));
                                    var e = document.createElement("div");
                                    return e.classList.add("vex-dialog-input"), (extraContentClass != '' ? e.classList.add(extraContentClass):''), e.appendChild(a.input instanceof window.Node ? a.input : d(a.input)), b.appendChild(c), b.appendChild(e), b
                                },
                                g = function(a) {
