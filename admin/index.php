...
<html lang="<?php echo $alang['meta.lang'] ?>">
    ...
    <head>
        ...
        <title><?php echo $alang['title.start'] ?></title>
                ...
                <div class="page-fixed-main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo URL ?>/users">
                                <div class="visual">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> <?php echo $alang['overview.clients'] ?> </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 red" href="<?php echo URL ?>/users">
                                <div class="visual">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> <?php echo $alang['overview.psicos'] ?> </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="<?php echo $db->query('SELECT user_id FROM users_invoices WHERE success=1')->num_rows; ?>">0</span>
                                    </div>
                                    <div class="desc"> <?php echo $alang['overview.paids'] ?> </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 purple" href="<?php echo URL ?>/adminsMgr">
                                <div class="visual">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> <?php echo $alang['overview.admins'] ?> </div>
                                </div>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase"><?php echo $alang['frontpage.logs'] ?></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_1_1">
                                            <div class="scroller" style="height: 339px;" data-always-visible="1" data-rail-visible="0">
                                                <ul class="feeds">
                                                    <?php
                                                    $logData = $db->query('SELECT al.type,INET_NTOA(al.ip),au.user,al.timestamp FROM admin_logs al JOIN admin_users au ON al.userId=au.id ORDER BY al.timestamp DESC LIMIT '.config('admin.logs.maxtoshow'));
                                                    while($thisLog = $logData->fetch_row())
                                                    {
                                                        ...
                                                        <div class="col1">
                                                            <div class="cont">
                                                                ...
                                                                <div class="cont-col2">
                                                                    <div class="desc">[<b>'.$thisLog[1].'</b>] [<b>'.$thisLog[2].'</b>] '.$alang['log.'.str_replace('_','.',$thisLog[0])].' </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col2">
