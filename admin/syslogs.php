...
ini_set('memory_limit', '-1'); //No memory limit for reading log files
?>
<!DOCTYPE html>
...
<html lang="<?php echo $alang['meta.lang'] ?>">
    ...
    <head>
        ...
        <title><?php echo $alang['title.syslogs'] ?></title>
    ...
    <body class="" data-toggle="context" data-target="#context-menu">
                        ...
                        <div class="topbar-actions">
                            ...
                            <form class="search-form" action="extra_search.html" method="GET">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="<?php echo $alang['menu.search.ph'] ?>" name="query">
        ...
        <div class="container-fluid">
			...
			<li><?php echo $alang['path.syslogs'] ?></li>
                    </ul>
                    <!-- END BREADCRUMBS -->
                                    ...
                                    <div class="mt-element-list">
                                        <div class="mt-list-head list-todo red">
                                            <div class="list-head-title-container">
                                                <h3 class="list-title"><?php echo $alang['syslogs.title'] ?></h3>
                                                <div class="list-head-count">
                                                    <div class="list-head-count-item">
                                                        <i class="fa fa-file-o"></i> <?php $logDir = scandir(BASEDIR.'../..'); echo (count($logDir)-2) ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                       ...
                                       {
                                            if($fileName != '.' && $fileName != '..' && $fileName != 'desktop.ini' && stristr($fileName, '.log') !== false)
                                            {
                                                $fileNameFull = $fileName;
                                                $fileContents = @file_get_contents(BASEDIR.'../../'.$fileNameFull);
                                                if($fileContents !== false)
                                                {
                                                    $fileName = str_replace('.log',null,$fileName);
                                                    echo '<div class="mt-list-container list-todo" id="'.$fileName.'" role="tablist" aria-multiselectable="true">
                                                ...
                                                <ul>
                                                    <li class="mt-list-item">
                                                        ...
                                                        <div class="list-todo-item dark">
                                                            <a class="list-toggle-container collapsed" data-toggle="collapse" data-parent="#'.$fileName.'" onclick=" " href="#'.$fileName.'Var" aria-expanded="false">
                                                                <div class="list-toggle done uppercase">
                                                                    <div class="list-toggle-title bold">'.str_replace('_',' -> ',$fileName).'</div>
                                                                    <div class="badge badge-default pull-right bold">'.$alang['syslogs.lastModify'].': '.date('d/m/Y - H:i:s', filemtime(BASEDIR.'../../'.$fileNameFull)).'</div>
                                                                </div>
                                                            </a>
                                                            <div class="task-list panel-collapse collapse" id="'.$fileName.'Var" aria-expanded="false" style="height: 0px;">
                                                                <ul>
                                                                    <li class="task-list-item done">
                                                                        <div class="task-content" style="padding: 0 45px 0 0 !important">
                                                                            <p><pre><code>'.str_replace(array('<','>'),array('&#60;','&#62;'),$fileContents).'</code></pre></p>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
