        ...
        <div class="container-fluid">
            <div class="page-content page-content-popup">
                ...
                <div class="page-fixed-main-content">
                    <h1>Solicitudes de contacto (Resueltas)</h1>
                    <h2><a href="<?php echo URL ?>/contacts" class="btn btn-primary">Solicitudes sin resolver</a></h2>
                    <table class="table table-bordered col-md-12" style="table-layout:fixed;">
                        <thead>
                          <tr>
                            <th class="text-center col-md-2">Fecha</th>
                            <th class="text-center col-md-10">Mensaje</th>
                          </tr>
                        </thead>
                        <tbody>
                            <?php
                            $adminsMgr = $db->query('SELECT c.timestamp,c.message,c.id FROM contacts c WHERE solved=1');
                            while($row = $adminsMgr->fetch_row())
                            {
                                echo '<tr>
                                        <td class="text-center col-md-2">'.date('d/m/Y H:m:i',$row[0]).'</td>
                                        <td class="text-center col-md-10" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis">'.$row[1].'</td>
                                      </tr>';
                            }
                            ?>
                        </tbody>
